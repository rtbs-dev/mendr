...
@_coconut_tco  #12 (line in Coconut source)
...
# trick to one-hot encode occurrences from walks
    ...
    return _coconut_tail_call(sparse.COO, idx, data=1, shape=(num_walks, num_nodes))  #28 (line in Coconut source)
